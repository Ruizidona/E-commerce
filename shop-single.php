...
<?php
    ...
    $filita = mysqli_fetch_array($re);
    $stock = $filita['inventario'];
          ...
          <div class="col-md-6">
           ...
           <p><?php echo $fila[2]; ?></p>
            ...
            <div class="mb-5">
               ...
               <?php
               $producto = "select * from productos where id=".$_GET['id'];
               ...
               $total = 0;
                 ...
                 $arregloCarrito =$producto;
                 
                 ?>
                    
                    <p class="text-primary font-weight-bold ">Productos disponibles:<?php echo $stock?></p>
            ...
            <p><button onclick="window.location.href='cart.php?id=<?php echo $fila[0]; ?>'" class="buy-now btn btn-sm btn-primary" <?php  echo ($stock <= 0) ? 'disabled="true"' : ''?>>Add To Cart</button></p>
