<?php 
  ...
  #########################################################################################
  #Reemplazar inner join por left join para que aparezcan pedidos hechos por no usuarios
      ...
      <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div id="collapse<?php echo $f['id'];?>" class="collapse" aria-labelledby="heading<?php echo $f['id'];?> data-parent="#accordion">
              ...
              <p>Estado del pedido:  <b><?php echo $f['status'];?> </b> </p> 
              ...
              ?>
               ...
               <p>Provincia:  <?php echo $fila[4];?> </p>
               <p>Codigo postal:  <?php echo $fila[5];?> </p>
                        <!-- TABLA de productos con $F2-->
               <table class="table">
            <thead>
              <tr>
                <th>Id</th>
